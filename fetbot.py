...
< 
<     embed = discord.Embed(title=o['name'], colour=0x006064,
...
<         arry = np.array([[datetime.strptime(o['local_date_time_full'],
<                                             "%Y%m%d%H%M%S"), o['air_temp']] for o in data[-1::-1]])
< 
<         x = arry[:, 0]
<         y = arry[:, 1]
<         fig, ax = plt.subplots()
...
<                     "/home/jonno/.fonts/NotoEmoji-Regular.ttf", size=size, encoding='unic')
<             except OSError:
<                 size = size - 2
<                 continue
<         else:
...
< @bot.command()
< async def genre(ctx):
<     prefixes = ['enterprise', '', 'post', 'indie', 'avant-garde', 'nautical', 'break', 'wub', 'chip', 'vintage', 'classic', 'virtuosic', 'death', 'instrumental', 'british', 'industrial', 'thrash', 'japanese', 'J', 'K', 'acoustic', 'progressive', 'power', 'glam', 'melodic', 'new wave', 'german', 'gothic', 'symphonic', 'grind', 'synth',
<                 'minimal', 'psychedelic', 'brutal', 'sexy', 'easy listening', 'christian', 'anime', 'stoner', 'comedy', 'sad', 'christmas', 'neo', 'russian', 'finnish', 'summer', 'underground', 'dream', 'pagan', 'minimal', 'ambient', 'nu', 'speed', 'contemporary', 'alt', 'acid', 'english', 'kvlt', 'cult', 'mu', 'raw', 'norwegian', 'viking', 'porn']
